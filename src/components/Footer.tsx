    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* О магазине */}
          <div>
            <h3 className="text-white mb-4">О магазине</h3>
            <p className="text-sm">
              КнигоМир — ваш онлайн-магазин качественной литературы. Мы предлагаем широкий выбор книг на любой вкус.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>© 2025 КнигоМир. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
